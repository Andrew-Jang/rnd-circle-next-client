...
const Collab = () => {
  ...
  const ResultCircle = () => (
    <div style={{ height: "calc(100svh - 9rem)" }} className="flex w-full items-center justify-center space-x-40">
      ...
      >
        ...
        <div className="px-3 py-1 border-2 rounded-full font-medium mt-8 flex items-center space-x-1 bg-[#FBFBFB] bg-opacity-90 cursor-default">
        ...
        <Link href={"/collab/result/details"}>
          <button className="px-6 py-3 border-2 rounded-full font-medium text-sm mt-8 hover:bg-gray-100 transition bg-[#FBFBFB] bg-opacity-90">
            <p>자세히 알아보기</p>
          </button>
        </Link>
      </div>
